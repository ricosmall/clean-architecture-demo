        ...
        <div class="middle-container">
          ...
          <div class="quantity-price-container">
            <div class="quantity-container">
              <label for="vertical" style="display: block; margin-bottom: 8px">Quantity</label>
              <InputNumber
...
export default defineComponent({
  ...
  setup(props) {
    const cartBloc = inject<CartBloc>('cartBloc');

    const handleQuantityChange = (e: { originalEvent: Event; value: number }) => {
      cartBloc?.editQuantityCartItem({ ...props }, e.value);
    };
